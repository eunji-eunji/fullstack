...
public class ShapeEx {
    public static void main(String[] args) {
        ...
        // 다형성 - Shape은 추상클래스이기 때문에 Shape[] Circle과 Rectangle 객체 모두 담을 수 있다.
        // 각 객체는 area()와 length() 메소드를 각기 다르게 구현하므로 해당 메소드가 호출될 때
        // 다르게 동작한다.
        // 추상클래스와 상속: Shape은 추상클래스이고, Circle과 Rectangle은 이를 상속받아 
        // 자신만의 방법으로 넓이와 둘레를 계산한다.
    }
}
