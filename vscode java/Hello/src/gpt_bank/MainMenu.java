...
import movie_teacher.AdminMenu;
    ...
    public Menu next() {
        ...
        switch (ch) {
            ...
            case "3" -> {
                ...
                } else System.out.println("출금 실패 (계좌 또는 비밀번호 확인 / 잔액 부족)");
            }
            case "4" -> {
                String num = input.readLine("계좌번호: ");
                String pw = input.readLine("비밀번호: ");
                ...
                } else System.out.println("계좌번호 또는 비밀번호 오류");
            }
            case "5" -> {
                ...
                } else System.out.println("이체 실패 (계좌/비밀번호 오류 또는 잔액 부족)");
            }
            case "6" -> {
